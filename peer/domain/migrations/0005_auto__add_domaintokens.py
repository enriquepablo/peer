...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DomainTokens'
        db.create_table('domain_domaintokens', (
        ...
        db.send_create_signal('domain', ['DomainTokens'])


    def backwards(self, orm):
        
        # Deleting model 'DomainTokens'
        db.delete_table('domain_domaintokens')
